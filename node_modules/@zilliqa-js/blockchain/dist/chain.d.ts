...
import { BlockchainInfo, BlockList, DsBlockObj, TransactionStatusObj, PendingTxns, Provider, RPCResponse, ShardingStructure, TransactionObj, MinerInfo, TxBlockObj, TxList, ZilliqaModule } from '@zilliqa-js/core';
export declare class Blockchain implements ZilliqaModule {
     ...
     *
     */
    getPendingTxns(): Promise<PendingTxns>;
    /**
     * getBalance
     *
